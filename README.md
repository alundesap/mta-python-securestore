...
If you are just interested in the python specifics of calling the API, you can find all the details in the [blob/master/python/server.py](python.server.py) file.
